...
export const metadata = {
  title: 'Reserve a seat — Rafa Guida Founder Workshop · June 22',
  description:
    'Apply for a free seat at the Igloo Media × Dollar Commerce founder workshop with Rafa Guida on June 22 at 12:00 PM ET.',
  alternates: { canonical: '/workshops/rafa-w1/apply' },
    ...
    <main className="iga-root" data-dc="fullscreen">
      <header className="iga-nav">
        <div className="iga-nav-inner">
          <Link href="/workshops/rafa-w1" className="iga-back" aria-label="Back to workshop">
      ...
      <section className="iga-hero">
        <div className="iga-hero-inner">
          <span className="iga-pill">
            <span className="iga-pill-dot" /> Workshop with Rafa Guida
          </span>
          ...
          <div className="iga-detail">
            <span><strong>Mon, Jun 22</strong> · 12:00 PM ET</span>
      ...
      <section className="iga-form-wrap">
        <WorkshopSignupForm workshopId="rafa-w1" />
      </section>
