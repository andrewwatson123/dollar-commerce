...
import { BASE_PRICES, BASE_MARKET_CAPS } from './index-base-data';
...
async function getDCIndexValue() {
  try {
    ...
    // All-time index value (base 100), cap-weighted to match site default
    const idx = computeIndex(prices, BASE_PRICES, BASE_MARKET_CAPS);
